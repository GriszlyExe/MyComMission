...
export default function TwoFactorAuthPage() {
  ...
  const email = (queryEmail===undefined || queryEmail===null)?"":queryEmail

  const startCooldown = () => {
    setIsResendDisabled(true);
    setCountdown(15); // 60 seconds cooldown
  };
        ...
        <div className="flex justify-center gap-2">
          {[...Array(6)].map((_, index) => (
            <input
              ...
              className="w-12 h-12 text-center text-2xl border-2 border-gray-300 rounded-lg focus:border-purple-600 focus:outline-none"
            />
          ))}
        </div>

...
export default function Post({ user, tags, content, image, timestamp }: PostProps) {
  ...
  return (
    <>
      { !hidden && <div className="card w-full max-w-lg bg-white p-4 shadow-xl border-2 border-primary">
        {/* Post Header */}
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-6">
            <EyeOffIcon className="my-3 cursor-pointer hover:text-red-600" onClick={() => setHidden(true)}/>
